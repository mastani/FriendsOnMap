...
public class TrackActivity1 extends FragmentActivity implements OnMapReadyCallback {
...
//    private double arzz1, arzz2, arzz3, arzz4, arzz5, tt1, tt2, tt3, tt4, tt5;
    ...
    LatLng pos = new LatLng(40.76793169992044, -73.98180484771729);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pos = new LatLng(Double.valueOf(lat), Double.valueOf(lon));

        //Toast.makeText(TrackActivity1.this, moh, Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(TrackActivity1.this, "tool :" + tt1 + " Arz : " + arzz1, Toast.LENGTH_LONG).show();
...
//            mMap.moveCamera(CameraUpdateFactory.newLatLng(list.get(4)));
            ...
            mMap.addMarker(new MarkerOptions().position(pos).title("مکان دوست"));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(pos));
        } catch (Exception e) {
            Toast.makeText(TrackActivity1.this, "موقعیت جغرافیایی کاربر در دسترس نیست", Toast.LENGTH_SHORT).show();
